    ...
    <div className="bg-cover bg-center h-full bg-no-repeat bg-[url('./public/dininghall.jpg')]">
      ...
      <div className="flex items-center justify-center h-9/10 gap-4 ">
        <div className="flex flex-col items-center justify-center gap-6 md:flex-row px-4">
          <div className="text-center sm:text-left sm:w-96 text-white mb-8 bg-gradient-to-r from-liberty-red to-liberty-navy rounded-lg shadow-lg p-6 px-8 opacity-95">
          ...
          <div className="flex flex-col items-center justify-center gap-4 w-full">
            ...
            />
<button className="rounded-lg h-12 w-36 text-center text-white font-semibold shadow-md 
  bg-gradient-to-r from-liberty-red to-red-600 
  hover:from-liberty-red-dark hover:to-red-800 
  transition-all duration-500 ease-in-out opacity-95">
